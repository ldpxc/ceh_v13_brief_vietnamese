...
### Các phương pháp tấn công mật khẩu khác
...
### Xác định lỗ hổng bằng GhostPack Seatbelt
...
### Privilege escalation qua NFS misconfiguration
...
### Thay đổi Group Policy để leo thang
...
### Privilege escalation qua Active Directory Certificate Services (ADCS)
