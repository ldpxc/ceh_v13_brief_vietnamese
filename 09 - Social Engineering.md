...
- **Các hành vi/Tâm lý dễ bị lợi dụng (Behaviors Vulnerable to Attacks):**
  ...
  - **Sự đồng thuận (Consensus/Social Proof):** Lợi dụng tâm lý đám đông (VD: tạo web giả mạo nhiều lời khen ngợi ảo).
  - **Sự khan hiếm (Scarcity):** Tạo cảm giác khan hiếm để thao túng quyết định mua hàng/nhấp link.
  - **Sự khẩn cấp (Urgency):** Thúc giục hành động ngay lập tức (Rất phổ biến trong mã độc tống tiền Ransomware).
...
- **Các giai đoạn của một cuộc tấn công Social Engineering:**
  ...
  3. Thiết lập mối quan hệ (Develop a Relationship).
  4. Khai thác (Exploit the Relationship).

**Các kỹ thuật xã hội dựa trên con người (Human-based Social Engineering) [Trang 1389 - 1400]:**

- **Impersonation (Mạo danh):** Kẻ tấn công đóng giả làm người hợp pháp hoặc người có thẩm quyền. Các hình thức phổ biến:
  - Đóng giả người dùng cuối hợp pháp (Legitimate end-user).
  - Đóng giả nhân vật quan trọng (Important user/VIP).
  - Đóng giả nhân viên hỗ trợ kỹ thuật (Technical support agent).
...
- **Phân loại Đánh cắp danh tính:**
  ...
  - **Criminal Identity Theft (Tội phạm):** Tội phạm sử dụng danh tính của người khác để trốn tránh truy nã hoặc cáo buộc hình sự.
  - **Financial Identity Theft (Tài chính):** Dùng thông tin thẻ/tài khoản ngân hàng của nạn nhân để rút tiền, mở tài khoản mới, xin cấp thẻ tín dụng mới.
  - **Driver's License Identity Theft (Bằng lái xe):** Mạo danh để chịu phạt giao thông thay hoặc để nạn nhân bị treo bằng.
  - **Medical / Insurance Identity Theft (Y tế / Bảo hiểm):** Dùng thông tin để trục lợi bảo hiểm y tế, dẫn đến sai lệch hồ sơ y khoa nguy hiểm đến tính mạng.
...
- SửQuy trình nhân bản giọng nói (Steps involved):\*\*
  1. _Thu thập dữ liệu (Data collection):_ Lấy file ghi âm giọng nói của mục tiêu từ bài phát biểu, podcast, mạng xã hội.
  2. _Huấn luyện mạng nơ-ron (Neural networks training):_ Đưa dữ liệu vào huấn luyện mô hình sâu (CNNs hoặc RNNs) để AI nhận diện mẫu và sắc thái giọng nói.
  3. _Tạo mẫu giọng nói (Create voice samples):_ Chuyển đổi văn bản đầu vào thành giọng nói tổng hợp khớp với giọng mục tiêu.
  4. _Mạo danh (Impersonation):_ Sử dụng mẫu sinh ra để gọi điện tống tiền, vượt qua lớp bảo mật sinh trắc học bằng giọng nói.
- \*\* dụng thuật toán Máy học (ML) và tổng hợp giọng nói để bắt chước tinh vi giọng nói của một cá nhân, bao gồm cả cao độ, ngữ điệu và phong cách. Kẻ tấn công dùng nó để gọi điện mạo danh tống tiền hoặc vượt qua bảo mật sinh trắc học.
...
- **Cách phòng chống Phishing chi tiết (How to Defend against Phishing Attacks) [Trang 1449]:**
  ...
  - Tránh phản hồi các email yêu cầu thông tin nhạy cảm.
  - Di chuột qua các liên kết (Hover over links) để xác định xem URL có trỏ đến vị trí hợp pháp hay không.
  - Không bao giờ cung cấp thông tin xác thực qua điện thoại.
  - Kiểm tra email để tìm các lỗi chính tả, ngữ pháp hoặc lời chào chung chung (generic salutations).
  - Xác nhận lại với người gửi trước khi cung cấp bất kỳ thông tin nào qua email.
  - Đảm bảo nhân viên sử dụng các trang web được bảo vệ bằng giao thức HTTPS.
  - Triển khai xác thực đa yếu tố (MFA) để ngăn chặn các cuộc tấn công whaling.
  - Chủ động liên hệ với tổ chức qua email hoặc số điện thoại chính thức được cung cấp trên website nếu có nghi ngờ.
  - Xác minh ảnh đại diện của một tài khoản đáng ngờ bằng cách thực hiện tìm kiếm hình ảnh ngược (reverse image search).
...
- **Front office và help desk (Lễ tân và Bộ phận hỗ trợ):**
  - Kỹ thuật tấn công: Eavesdropping, shoulder surfing, impersonation, persuasion, intimidation.
  - Phòng thủ: Đào tạo nhân viên không bao giờ tiết lộ mật khẩu/thông tin qua điện thoại. Thực thi chính sách nghiêm ngặt cho bộ phận này.
- **Technical support và system administrators (Hỗ trợ kỹ thuật và Quản trị hệ thống):**
  - Kỹ thuật tấn công: Impersonation, persuasion, intimidation, fake SMS, phone calls.
  - Phòng thủ: Đào tạo nhân viên quản trị tuyệt đối không tiết lộ mật khẩu qua email hoặc điện thoại.
- **Perimeter security (An ninh vành đai):**
  - Kỹ thuật tấn công: Impersonation, reverse social engineering, piggybacking, tailgating.
  - Phòng thủ: Triển khai thẻ ID nghiêm ngặt, token, xác thực sinh trắc học, đào tạo nhân viên và bố trí nhân viên bảo vệ.
- **Office (Văn phòng):**
  - Kỹ thuật tấn công: Shoulder surfing, eavesdropping, ingratiation.
  - Phòng thủ: Áp dụng danh sách kiểm tra thực hành tốt nhất cho mật khẩu. Luôn phải có người đi kèm với mọi khách truy cập (Escort all guests).
- **Vendors of the target organization (Nhà cung cấp):**
  - Phòng thủ: Giáo dục các nhà cung cấp về kỹ thuật xã hội.
- **Mail room (Phòng thư):**
  - Kỹ thuật tấn công: Đánh cắp, phá hoại hoặc giả mạo thư từ.
  - Phòng thủ: Khóa và giám sát phòng thư, đào tạo nhân viên chuyên trách.
- **Machine room và Phone closet (Phòng máy và Tủ điện thoại):**
  - Kỹ thuật tấn công: Cố gắng giành quyền truy cập vật lý, gỡ thiết bị hoặc gắn protocol analyzer.
  - Phòng thủ: Giữ các không gian này khóa kín 24/7 và cập nhật bản kiểm kê thiết bị thường xuyên.
- **Company’s Executives (Ban giám đốc công ty):**
  - Kỹ thuật tấn công: Fake SMS, phone calls, spear phishing.
  - Phòng thủ: Đào tạo ban giám đốc không bao giờ tiết lộ danh tính, mật khẩu qua điện thoại hay email.
- **Dumpsters (Thùng rác):**
...
### 4.2. Công cụ mô phỏng lừa đảo (Phishing simulation tool) [Trang 1459 - 1460]
